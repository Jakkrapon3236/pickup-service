...
import ModalEmCacel from "../modals-status/employee/cancel";
          ...
          <p className="text-2xl text-gray-400 font-custom">
                                ...
                                <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                    ...
                                    <td className="px-6 py-4">
                                        <button
                                            ...
                                            className="hover:underline"
                                        >
                                            <span className="inline-flex items-center bg-orange-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                                <span className="w-2 h-2 me-1 bg-orange-400 rounded-full"></span>
                                                เข้ารับพัสดุสำเร็จแล้ว
                                            </span>
                                        </button>
                                    </td>
                                </tr>
                                    ...
                                    <td className="px-6 py-4">
                                        ...
                                        >
                                            <span className="inline-flex items-center bg-blue-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                                <span className="w-2 h-2 me-1 bg-blue-300 rounded-full"></span>
                                                รอหลักฐานการชำระเงิน
                                            </span>
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                    ...
                                    <td className="px-6 py-4">
                                        <button
                                            ...
                                            className="hover:underline"
                                        >
                                            <span className="inline-flex items-center bg-violet-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                                <span className="w-2 h-2 me-1 bg-violet-300 rounded-full"></span>
                                    ...
                                    <td className="px-6 py-4">
                                        ...
                                        >
                                            <span className="inline-flex items-center bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300">
                                                <span className="w-2 h-2 me-1 bg-green-300 rounded-full"></span>
                                                ชำระสำเร็จ
                                            </span>
                                        </button>
                                    </td>
            ...
            {isModalOpen && (
                <>
                    ...
                    {status === 2 && ModalImage() }
                    {status === 3 && <ModalEmBill handleToggleModal={handleToggleModal} /> }
                    {status === 4 && <ModalEmCacel handleToggleModal={handleToggleModal} />}
